...
namespace Castle.ActiveRecord.ByteCode.Collection
{
    ...
    class PersistentArrayHolder : NHibernate.Collection.PersistentArrayHolder 
    {
        public PersistentArrayHolder(ISessionImplementor session, object array) : base(session, array) { }

        public PersistentArrayHolder(ISessionImplementor session, ICollectionPersister persister) : base(session, persister) { }
