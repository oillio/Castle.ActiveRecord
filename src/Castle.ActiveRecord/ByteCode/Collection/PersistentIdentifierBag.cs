...
namespace Castle.ActiveRecord.ByteCode.Collection
{
    ...
    class PersistentIdentifierBag : NHibernate.Collection.PersistentIdentifierBag
    {
        public PersistentIdentifierBag() { }

		public PersistentIdentifierBag(ISessionImplementor session) : base(session) { }

        public PersistentIdentifierBag(ISessionImplementor session, ICollection coll) : base(session, coll) { }
