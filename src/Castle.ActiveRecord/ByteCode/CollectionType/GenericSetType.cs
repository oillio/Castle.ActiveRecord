...
namespace Castle.ActiveRecord.ByteCode
{
    ...
    [Serializable]
    class GenericSetType<T> : NHibernate.Type.GenericSetType<T>
    {
        /// <summary>
        ...
        /// <summary>
        /// Wraps an <see cref="IList{T}"/> in a PersistentGenericSet.
        /// </summary>
        /// <param name="session">The <see cref="ISessionImplementor"/> for the collection to be a part of.</param>
        /// <param name="collection">The unwrapped <see cref="IList{T}"/>.</param>
        /// <returns>
        /// An PersistentGenericSet that wraps the non NHibernate <see cref="IList{T}"/>.
        /// </returns>
