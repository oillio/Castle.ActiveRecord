...
namespace Castle.ActiveRecord.ByteCode
{
    ...
    class GenericListType<T> : NHibernate.Type.GenericListType<T>
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="NHibernate.Collection.IPersistentCollection"/> for the list.
        /// </summary>
        ...
        {
            return new PersistentGenericList<T>(session) { IsLazy = persister.IsLazy };
        }
    }
}
