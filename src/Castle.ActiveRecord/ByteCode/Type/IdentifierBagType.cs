...
namespace Castle.ActiveRecord.ByteCode
{
    ...
    class IdentifierBagType : NHibernate.Type.IdentifierBagType
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="NHibernate.Collection.IPersistentCollection"/> for the identifier bag.
        /// </summary>
        ...
        {
            return new PersistentIdentifierBag(session) { IsLazy = persister.IsLazy };
        }
    }
}
