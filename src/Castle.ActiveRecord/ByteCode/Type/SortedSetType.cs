...
namespace Castle.ActiveRecord.ByteCode
{
    ...
    [Serializable]
    class SortedSetType : NHibernate.Type.SortedSetType
    {
        /// <summary>
        /// Initializes a new instance of a <see cref="SortedSetType"/> class for
        /// a specific role using the IComparer{T} to do the sorting.
        /// </summary>
        /// <param name="role">The role the persistent collection is in.</param>
        /// <param name="propertyRef">The name of the property in the
        /// owner object containing the collection ID, or <see langword="null" /> if it is
        /// the primary key.</param>
        /// <param name="comparer">The IComparer{T} to use for the sorting.</param>
        ...
        {
            return new PersistentSet(session) { IsLazy = persister.IsLazy };
        }
    }
}
